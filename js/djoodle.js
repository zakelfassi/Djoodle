 ...
 * @param {Object} _this The context. (the Djoodle Object).
 */
Djoodle.prototype.handleKeyPress = function(e, _this) {
  _this.playDjembeByKeyCode(e.keyCode);
};
 ...
 * @param {Object} _this The context. (the Djoodle Object).
 */
Djoodle.prototype.touchDjembe = function(e, _this) {
 ...
 */
Djoodle.prototype.handleRecordButton = function(e, _this) {
 ...
 */
Djoodle.prototype.recordKey = function(e, _this) {
  var ascii = e.keyCode;
  //var song = new Array();
...
Djoodle.prototype.playSongData = function(songData) {
  // Sets a setTimeout function and plays keys according to playDjembe(n).
	...
	while(i < songData.length - 1) { //songData.length != 0
		...
		_this.playDjembeByKeyCode(keyToPlay);
